...
(defn shadow-build-conf [build-id]
  {:cljfx       true
   ...
   :build-hooks [(list `release-hook build-id)]})
...
(comment
 (new-web-view :typing-monkeys.components.codemirror)
 (fx/on-fx-thread
  (fx/create-component
   {:fx/type :stage
    :showing true
    :scene   {:fx/type :scene
              :root    (wv/web-view {:url "https://microsoft.github.io/monaco-editor/index.html"
