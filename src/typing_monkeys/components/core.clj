...
(defn dropdown [{:keys [get-state set-state]}]
   ...
   :scene   {:fx/type :scene
             :root    {:fx/type  :v-box
                       :children [{:fx/type   multi-select
                                  ...
                                  {:fx/type   dropdown
                                   :get-state (fn [] (:dd @*state))
                                   :set-state (fn [state] (swap! *state assoc :dd state))}]}}})
