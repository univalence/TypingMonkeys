...
(require '[typing-monkeys.components.codemirror.core :as cm]
    ...
    {:left   {:fx/type :scroll-pane
     ...
     :center {:fx/type        :scroll-pane
              ...
              :content        {:fx/type        :v-box
                               ;; :on-key-pressed {:event/type :text.keypressed}
                               :children       [(flow-pane (mapv member members))
                                                (cm/component {:dev true
                                                               :on-load (fn [_ _] (wv/send! :typing-monkeys.components.codemirror
                                                                                            [:put :value text]))})]}}}))

(comment
 (wv/send! :typing-monkeys.components.codemirror
           [:put :value "pouet"]))